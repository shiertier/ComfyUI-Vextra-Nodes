...
if not os.path.exists(f'models/huggingface/distilgpt2-stable-diffusion-v2'):
    print('Downloading model...')
    os.system(f'git clone https://huggingface.co/FredZhang7/distilgpt2-stable-diffusion-v2 models/huggingface/distilgpt2-stable-diffusion-v2')

tokenizer = GPT2Tokenizer.from_pretrained('distilgpt2', cache_dir='models/huggingface')
tokenizer.add_special_tokens({'pad_token': '[PAD]'})
model = GPT2LMHeadModel.from_pretrained('models/huggingface/distilgpt2-stable-diffusion-v2')
